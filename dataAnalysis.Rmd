...
library(readxl)
timeRecord <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/生理测量数据/生理数据时间对应表.csv", header=T)
...
```{r}
library(readxl)
subjective <- read_excel("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/主观测量/subjective.xlsx")
head(subjective)
subjective <- data.frame(subjective)

library(reshape2)
longData <- melt(subjective, id.vars = "Participant", measure.vars = c("E1", "E2", "E3", "E4", "E5", "E6", "E7", "E8"), variable.name = "event")
names(longData) <- c("participant", "event", "pressure")
longData$participant <- factor(longData$participant)
longData$pressure <- as.numeric(longData$pressure)
graph.subjective <- summarySEwithin(longData, measurevar = "pressure", withinvars = "event", idvar = "participant", na.rm = T, conf.interval = .95)
graph.subjective

library(ggplot2)
ggplot(graph.subjective, aes(x=event, y=pressure, group=1)) + geom_line() + geom_errorbar(width=.1, aes(ymin=pressure-se, ymax=pressure+se)) + geom_point(shape=21, size=3, fill = "white")
ggsave("subjective-pressure.png")
```
...
HT = 10
# Participant1
listOfStressTime <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/面部特征/listOfStressTime.csv", header=T)
listOfEventTime <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/面部特征/listOfEventTime.csv", header=T)
...
write.csv(facial.p1.t2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p1.t2.L.csv")
```
...
write.csv(facial.p1.t1.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p1.t1.L.csv")
...
write.csv(facial.p2.t2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p2.t2.L.csv")
...
write.csv(facial.p2.t1.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p2.t1.L.csv")
...
write.csv(facial.p3.t2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p3.t2.L.csv")
...
write.csv(facial.p3.t1.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p3.t1.L.csv")
...
write.csv(facial.p4.t2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p4.t2.L.csv")
...
write.csv(facial.p4.t1.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p4.t1.L.csv")
...
write.csv(facial.p5.t2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p5.t2.L.csv")
...
write.csv(facial.p5.t1.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p5.t1.L.csv")
...
write.csv(facial.p6.t2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p6.t2.L.csv")
...
write.csv(facial.p6.t1.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p6.t1.L.csv")
...
write.csv(facial.p7.t2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p7.t2.L.csv")
...
write.csv(facial.p7.t1.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p7.t1.L.csv")
...
write.csv(facial.p8.t2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p8.t2.L.csv")
...
write.csv(facial.p8.t1.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p8.t1.L.csv")
...
write.csv(facial.p9.t2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p9.t2.L.csv")
...
write.csv(facial.p9.t1.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p9.t1.L.csv")
...
write.csv(facial.p10.t2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p10.t2.L.csv")
...
write.csv(facial.p10.t1.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p10.t1.L.csv")
...
write.csv(facial.p2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p2.L.csv")
write.csv(facial.p3.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p3.L.csv")
write.csv(facial.p4.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p4.L.csv")
write.csv(facial.p5.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p5.L.csv")
write.csv(facial.p6.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p6.L.csv")
write.csv(facial.p7.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p7.L.csv")
write.csv(facial.p8.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p8.L.csv")
write.csv(facial.p9.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p9.L.csv")
write.csv(facial.p10.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p10.L.csv")
write.csv(facial.pressure, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.pressure.csv")
...
write.csv(facial.all, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.all.csv")
```


## Feature selection

We need to choose the features with the largest variance and delete those features almost don't change.
```{r}
library
facial.all <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.all.csv", header = TRUE)
facial.all <- select(facial.all, -c(54:55)) %>%
...
stats <- sapply(facial.all, mystats)  
stats <- t(data.frame(stats))
write.csv(stats, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/statsForFacialFeatures.csv")
```

```{r}
facial.p2.L <- read.csv(file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p2.L.csv") %>% select(-c("X", "tongueOut", "jawLeft", "mouthLeft", "mouthRight", "jawRight", "mouthClose", "browOuterUpRight", "browOuterUpLeft", "timeStamp", "accurateTime"))

facial.p3.L <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p3.L.csv") %>%  select(-c("X", "tongueOut", "jawLeft", "mouthLeft", "mouthRight", "jawRight", "mouthClose", "browOuterUpRight", "browOuterUpLeft", "timeStamp", "accurateTime"))
facial.p4.L <- read.csv(file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p4.L.csv") %>% select(-c("X", "tongueOut", "jawLeft", "mouthLeft", "mouthRight", "jawRight", "mouthClose", "browOuterUpRight", "browOuterUpLeft", "timeStamp", "accurateTime"))
facial.p5.L <- read.csv(file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p5.L.csv") %>% select(-c("X", "tongueOut", "jawLeft", "mouthLeft", "mouthRight", "jawRight", "mouthClose", "browOuterUpRight", "browOuterUpLeft", "timeStamp", "accurateTime"))
facial.p6.L <- read.csv(file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p6.L.csv") %>% select(-c("X", "tongueOut", "jawLeft", "mouthLeft", "mouthRight", "jawRight", "mouthClose", "browOuterUpRight", "browOuterUpLeft", "timeStamp", "accurateTime"))
facial.p7.L <- read.csv(file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p7.L.csv") %>% select(-c("X", "tongueOut", "jawLeft", "mouthLeft", "mouthRight", "jawRight", "mouthClose", "browOuterUpRight", "browOuterUpLeft", "timeStamp", "accurateTime"))
facial.p8.L <- read.csv(file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p8.L.csv") %>% select(-c("X", "tongueOut", "jawLeft", "mouthLeft", "mouthRight", "jawRight", "mouthClose", "browOuterUpRight", "browOuterUpLeft", "timeStamp", "accurateTime"))
facial.p9.L <- read.csv(file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p9.L.csv") %>% select(-c("X", "tongueOut", "jawLeft", "mouthLeft", "mouthRight", "jawRight", "mouthClose", "browOuterUpRight", "browOuterUpLeft", "timeStamp", "accurateTime"))

facial.p10.L <- read.csv(file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p10.L.csv") %>% select(-c("X", "tongueOut", "jawLeft", "mouthLeft", "mouthRight", "jawRight", "mouthClose", "browOuterUpRight", "browOuterUpLeft", "timeStamp", "accurateTime"))

facial.stress <- read.csv(file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.all.csv") %>% select(-c("X", "tongueOut", "jawLeft", "mouthLeft", "mouthRight", "jawRight", "mouthClose", "browOuterUpRight", "browOuterUpLeft", "timeStamp", "accurateTime"))

write.csv(facial.p2.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p2.featureSelected.csv")
write.csv(facial.p3.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p3.featureSelected.csv")
write.csv(facial.p4.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p4.featureSelected.csv")
write.csv(facial.p5.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p5.featureSelected.csv")
write.csv(facial.p6.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p6.featureSelected.csv")
write.csv(facial.p7.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p7.featureSelected.csv")
write.csv(facial.p8.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p8.featureSelected.csv")
write.csv(facial.p9.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p9.featureSelected.csv")
write.csv(facial.p10.L, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.p10.featureSelected.csv")
write.csv(facial.stress, file = "~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/处理后/facial.stress.featureSelected.csv")
...
kNN <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/MATLAB/kNN.txt")
Tree <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/MATLAB/Tree.txt")
LDA <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/MATLAB/LDA.txt")
SVM <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/MATLAB/SVM.txt")
Log <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/MATLAB/Log.txt")
Bys <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/MATLAB/Bys.txt")
Boost <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/MATLAB/Boost.txt")
```

```{r}
# draw the ROC
rockNN <- roc(kNN$stressLevel, kNN$predict)
plot(rockNN, print.auc = T, plot = T, print.thres = T, smooth = T, asp = 0)
rocTree <- roc(Tree$stressLevel, Tree$predict)
plot(rocTree, print.auc = T, plot = T, print.thres = T, smooth = T, asp = 0)
rocLDA <- roc(LDA$stressLevel, LDA$predict)
plot(rocLDA, print.auc = T, plot = T, print.thres = T, smooth = T, asp = 0)
rocSVM <- roc(SVM$stressLevel, SVM$predict)
rocLog <- roc(Log$stressLevel, Log$predict)
rocBys <- roc(Bys$stressLevel, Bys$predict)
rocBoost <- roc(Boost$stressLevel, Boost$predict)
plot(rocSVM, print.auc = T, plot = T, print.thres = T, smooth = T, asp = 0)
plot(rocLog, print.auc = T, plot = T, print.thres = T, smooth = T, asp = 0)
plot(rocBys, print.auc = T, plot = T, print.thres = T, smooth = T, asp = 0)
plot(rocBoost, print.auc = T, plot = T, print.thres = T, smooth = T, asp = 0)
...
library(pastecs)
library(reshape)
PCA <- read.csv("~/Documents/Graduate3/HFM/Group Project/driver-stress-detection/实验数据/面部特征/PCA.csv", header=FALSE)
PCA <- PCA[,1:52]
